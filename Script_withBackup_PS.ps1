...
REM 	Version 2.0.0
REM 	Changelog: 
REM		v2.0.0:Translating my script into powershell
...
echo ****************************** File extracted, Backing up Previous version ****************************** >> %LOG%
xcopy "C:\Program Files\terraform" "%CD%\Backup\terraform_%InstalledVersion%.exe*" /y  >> %LOG%

echo ****************************** Updating Binary ****************************** >> %LOG%
